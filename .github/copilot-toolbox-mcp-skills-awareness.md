...
_Generated: 2026-05-28T11:03:15.259Z_
...
Workspace `mcp.json` _(folder: codespaces-example)_

- **c:\Users\X012640\codespaces\codespaces-example\.vscode\mcp.json** — _File missing_

_No active workspace servers in mcp.json._

## MCP — user profile

- **C:\Users\X012640\AppData\Roaming\Code\User\mcp.json** — _File exists — servers defined_

| Server id | Kind | Detail |
|-----------|------|--------|
| tr-code-scan-mcp | stdio | C:\Users\X012640\TR\tr-code-scan-windows.exe mcp-server |
